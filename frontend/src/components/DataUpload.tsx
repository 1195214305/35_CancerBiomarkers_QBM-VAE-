...
export default function DataUpload({ onDataUploaded }: DataUploadProps) {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="bg-slate-800/50 backdrop-blur-sm border border-primary/30 rounded-xl p-8">
        ...
        <div className="mb-6">
          ...
          <div className="border-2 border-dashed border-primary/30 rounded-lg p-8 text-center hover:border-primary/50 transition-colors bg-slate-800/30">
            <input
              type="file"
              accept=".csv,.txt,.tsv"
        ...
        <button
          ...
          className="w-full bg-primary hover:bg-secondary disabled:bg-slate-700 disabled:text-gray-500 text-white font-medium py-3 px-6 rounded-lg transition-colors flex items-center justify-center gap-2"
        >
          {uploading ? (
            <>
